...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'en_US': {
      ...
      'file_format': 'PDF, DOC, DOCx or TXT (MAX. 1MB)',
      'back': 'Back',
      'experience_year_hint': 'Less or equal 5',
      'year': 'Year',
      ...
      'company_size_hint': 'Select company size',
      'company_size_error': 'Please select company size',
      'self_employed': 'Self-employed, Sole trader',
      'two_to_ten': '2-10',
      'eleven_to_fifty': '11-50',
      'fifty_one_to_two_hundred': '51-200',
      'two_hundred_one_to_five_hundred': '201-500',
      'organization_type_hint': 'Select organization Type',
      ...
      'interested_industry_hint': 'Enter industry',
      'interested_industry_error': 'Industry cannot be empty',
      'view_all': 'View All',
      ...
      'manage_your_company_contact_details':
          'Manage your company contact details',
      'select_a_payment_method': 'Select a Payment Method',
      'credit_card': 'Credit Card',
      'credit_card_number': 'Credit Card Number',
      'credit_card_number_hint': '0000 0000 0000 0000',
      'credit_card_number_error': 'Credit card number cannot be blank',
      'card_holder_name': 'Card Holder Name',
      'card_holder_name_hint': 'Name here',
      'card_holder_name_error': 'Card holder name cannot be blank',
      'expiry_date': 'Expiry Date',
      'expiry_date_hint': '05/2025',
      'expiry_date_error': 'Expiry date cannot be blank',
      'security_code': 'Security Code',
      'security_code_hint': 'CVV',
      'security_code_error': 'Security code cannot be blank',
      'bank_account': 'Bank Account',
      'bank_name': 'Bank Name',
      'bank_name_hint': 'Select Bank',
      'bank_name_error': 'Bank name cannot be blank',
      'iban': 'IBAN',
      'iban_hint': '0000 0000 0000 0000',
      'iban_error': 'IBAN cannot be empty',
      'account_name': 'Account Name',
      'account_name_hint': 'Name here',
      'account_name_error': 'Account name cannot be blank',
