...
import 'package:sanad/view/recruiter/navigation/applyJob/additionalRequirementJob/widget/back_button_widget.dart';
import 'package:sanad/view/recruiter/navigation/applyJob/additionalRequirementJob/widget/input_experience_year_widget.dart';
import 'package:sanad/view/recruiter/navigation/applyJob/additionalRequirementJob/widget/software_program_cart_widget.dart';
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              child: ListView.separated(
                                ...
                                itemBuilder: (context, index) {
                                  return SoftwareProgramCartWidget(
                                    softwareProgram: softwarePrograms[index],
                                  );
                                },
                              ),
                            ),
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Expanded(
                                          child: InputExperienceYearWidget(),
                                        ),
                                        SizedBox(
                                          width:
                                              Get.width *
                                              Utils.getResponsiveWidth(100),
                                        ),
                                        Container(
                                          width:
                                              Get.width *
                                              Utils.getResponsiveWidth(68),
                                          height:
                                              Get.height *
                                              Utils.getResponsiveHeight(38),
                                          decoration: BoxDecoration(
                                            color:
                                                Theme.of(
                                                  context,
                                                ).extension<AppColors>()?.bg,
                                            borderRadius: BorderRadius.all(
                                              Radius.circular(
                                                Get.height *
                          ...
                          Row(
                            ...
                            children: [BackButtonWidget(), NextButtonWidget()],
                          ),
                        ],
                      ),
                    ),
