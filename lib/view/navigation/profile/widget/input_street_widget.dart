...
class InputStreetWidget extends StatelessWidget {
  InputStreetWidget({super.key});
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      return TextFormField(
        controller: updateProfileVM.streetController.value,
        focusNode: updateProfileVM.streetFocusNode.value,
        enableSuggestions: true,
        autovalidateMode: AutovalidateMode.onUserInteraction,
        validator: (value) {
          if (value == null || value.isEmpty) {
            return 'street_error'.tr;
          }
          return null;
        },
